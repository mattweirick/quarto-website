...
bibliography: 
  - '/Users/Matt/Documents/markdown files/My Library2.bib'
...
```{r, prepare-data}
#| include: false
e <- read.csv("/Users/Matt/Documents/Research Project Admin/emotional_labor/emotional-labor-data.csv")
e <- e[-c(1,2),]
e <- e[,-c(1:10)]
e <- e %>%
...
: Descriptive statistics for each question in the CBI. Note: For all questions, N = 372, Min = 0, Max = 100, and no responses are missing.
